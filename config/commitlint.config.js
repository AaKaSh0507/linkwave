...
module.exports = {
  ...
  prompt: {
    questions: {
      ...
      scope: {
        description: 'What is the scope of this change (e.g., api, frontend, auth)',
      },
      subject: {
      ...
      breakingBody: {
        description: 'A BREAKING CHANGE commit requires a body. Describe the breaking changes',
      },
      breaking: {
      ...
      issuesBody: {
        description: 'If issues are closed, the commit requires a body. Add a longer description',
      },
      issues: {

...
/**
 * Development initializer that logs startup information for the chat system. This component
 * displays helpful information when the application starts.
 */
@Component
public class ChatDevInitializer {
  ...
  /**
   * Logs startup information when the application is ready. Displays testing instructions for the

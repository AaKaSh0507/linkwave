...
public class MessageHistoryController {
    ...
    public MessageHistoryController(MessageHistoryService messageHistoryService, SessionService sessionService) {
    ...
    public ResponseEntity<?> getMessageHistory(
        ...
        try {
            ...
            PaginatedMessagesResponse response = messageHistoryService.getDirectMessageHistoryPaginated(
                    user.getPhoneNumber(),
                    recipientId,
                    beforeTimestamp);

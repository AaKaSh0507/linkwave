...
public class SessionService {
  ...
  private int getSessionTimeoutMinutes() {
    return redisConfig != null
        ? redisConfig.getSessionTimeoutMinutes()
  ...
  public SessionMetadata createSessionFor(String phoneNumber) {
    ...
    SessionMetadata metadata = new SessionMetadata(session.getId(), now, expiresAt);
  ...
  public Optional<SessionMetadata> getCurrentSessionMetadata() {
    ...
    SessionMetadata metadata =
        new SessionMetadata(session.getId(), createdAt, expiresAt, phoneNumber);
